...
def get_themes(theme_list_str,subtitles_path,save_path):
    ...
    subtitles_path = subtitles_path.strip()
                ...
                with gr.Column():
                    ...
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            get_network_graph_button.click(get_character_network, inputs=[subtitles_path, ner_path],
                    ...
                    with gr.Column():
                        ...
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                classify_text_button.click(classify_text, inputs=[text_classifcation_model,
